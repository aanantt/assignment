...
import 'package:assign/controllers/data_controller.dart';
import 'package:assign/screens/home_screen/components/category_list.dart';
import 'package:assign/screens/home_screen/components/feed_news.dart';
import 'package:assign/screens/home_screen/components/search_bar.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBar(),
      body: FutureBuilder(
        future: dataControllers.loadData(context),
